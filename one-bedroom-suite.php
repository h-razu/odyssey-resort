...
<head>
    ...
    <title>Odyssey Resort- One-Bedroom Suite</title>
</head>
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li>
                                    <a class="dropdown-item active" href="one-bedroom-suite.php">One-Bedroom Suite</a>
                                </li>
                                <li>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="one-bedroom-carousel">
                        <div id="carousel-container-one-bed" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active obs-image-content">
                                    <img src="images/one-1.jfif" alt="slide image-01" />
                                </div>
                                <div class="carousel-item ob-image-content">
                                    <img src="images/one-2.jfif" alt="slide image-02" />
                                </div>
                                <div class="carousel-item obs-image-content">
                                    <img src="images/one-3.jfif" alt="slide image-03" />
                                </div>
                                <div class="carousel-item obs-image-content">
                                    <img src="images/one-4.jfif" alt="slide image-04" />
                                </div>
                                <div class="carousel-item obs-image-content">
                                    <img src="images/one-5.jfif" alt="slide image-05" />
                                </div>
                                <button class="carousel-control-prev" type="button" data-bs-target="#carousel-container-one-bed" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon"></span>
                                </button>
                                <button class="carousel-control-next" type="button" data-bs-target="#carousel-container-one-bed" data-bs-slide="next">
                                    <span class="carousel-control-next-icon"></span>
                                </button>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="suite-info">
                        <h4>Room Capacity</h4>
                        <h6>
                            <i class="fa-solid fa-bed"></i><span>2 Adult(s) / Room</span>
                        </h6>
                        <h3>Amenities & Service</h3>
                        <ul>
                            <li><i class="fa-solid fa-angles-right"></i><span>24 Hours Room Service</span></li>
                            <li><i class="fa-solid fa-angles-right"></i><span>Queen size bed</span></li>
                            <li><i class="fa-solid fa-angles-right"></i><span>Shower Cabinet</span></li>
